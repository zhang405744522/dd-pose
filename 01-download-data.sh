...
function download_file()
{
    ...
    STATUS_CODE=$(curl --fail --basic --user ekaterina.kokoulina@rwth-aachen.de:ekaterina1kokulina2dd-pose3 --head --silent --write-out "%{http_code}" $DD_POSE_DOWNLOAD_URI/$FILE  --output /dev/null)
